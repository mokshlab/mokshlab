...
🤖 AI Invoice Gen | ⚡ Cron-based Overdue Detect | 📊 Recharts Dashboard | 🔐 Cross-domain JWT Auth

</div>

- **The Build**: Developed an AI-powered financial tool using React and Node.js, integrating **Google Gemini AI** for natural language invoice generation and smart data insights.  
- **The Impact**: Automated billing lifecycles completely with **race-condition-safe auto-numbering**, daily cron-based overdue detection, cross-domain JWT cookie auth, and SMTP delivery.
...
🕸️ Zero-dep Canvas Physics Graph | 🔐 OWASP-Aligned Security | 📅 365-day Heatmap | ✨ WCAG Accessible
